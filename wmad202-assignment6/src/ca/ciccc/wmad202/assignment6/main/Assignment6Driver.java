...
import ca.ciccc.wmad202.assignment6.problem1.Drinks;
...
public static void run(){
    ...
    Drinks drink= new Drinks(102,"Coca Cola", 2,"USA",false,330);
    ...
    Drinks pepsi= new Drinks(412,"Pepsi", 2,"USA",false,150);
    Drinks gingerZero= new Drinks(183,"Ginger Zero", 3,"Canada",true,200);
